...
export default function CompanyDetail({ id, action, model, saving, onSave }: Props) {
    const validationSchema = yup.object().shape({
        name: yup.string()
            ...
            .test(
                ...
                async (value) => !!value && value.length > 0 && !(await requestHelper.Companies.companyExists(value, id))
            )
    });
